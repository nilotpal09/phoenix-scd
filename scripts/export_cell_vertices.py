...
#layer_mergeFactors = [ 4, 4, 8, 1, 16, 16, 32 ]

#r_all       = [ 1500, 1900, 2500, 3000, 3500, 4000, 4500 ]
nLayers     = len( r_all ) - 1
...
#fig,ax=plt.subplots(figsize=(40, 20),dpi=500)
