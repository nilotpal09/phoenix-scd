...
export class ScdComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if (environment?.singleEvent) {
      ...
      defaultEvent = {
        // eventFile: 'assets/files/scd/scd_single_jet_dump.json', 
        // eventFile: 'assets/files/scd/scd_ttbar_dump.json', 
        // eventFile: 'assets/files/scd/scd_ttbar_with_polyhedra.json', 
